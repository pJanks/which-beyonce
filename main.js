...
var secondStart = document.querySelector(".overview-button")

startButton.addEventListener("click", formValidation);
secondStart.addEventListener("click", startGame);
...
function goToInstructions() {
  ...
  page.innerHTML = `<main class="overview-page">
    <section class="overview-content">
      <h2 class="welcome">WELCOME PLAYER 1 NAME AND PLAYER 2 NAME!</h2>
